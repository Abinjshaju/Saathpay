      ...
      <div className="lg:mx-auto lg:w-full lg:max-w-lg lg:py-6">
        ...
        <div className="mx-auto mt-8 w-full max-w-md px-5">
          ...
          <div className="mt-3 list-card">
            ...
            <div className="flex items-start justify-between gap-4 px-5 py-4">
              <p className="shrink-0 text-xs font-bold uppercase tracking-wider text-ink-muted">Business</p>
              <p className="min-w-0 flex-1 break-words text-right text-sm text-ink">{user?.business_name ?? "—"}</p>
            </div>
