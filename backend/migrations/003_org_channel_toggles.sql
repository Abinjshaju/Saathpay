-- Organisation-level messaging channel toggles
...
-- Update onboarding RPC to accept the new toggle fields.
-- (This function is already defined in earlier migrations; we replace it here.)
...
begin
  ...
  values (
    ...
    payload->>'upi_id',
    payload->>'upi_number',
    coalesce((payload->>'whatsapp_enabled')::boolean, true),
    coalesce((payload->>'sms_enabled')::boolean, false)
  )
